...
namespace Decorator_CustomCodeBuilderExample
{
    

    //we cannot inheritance because
    //string builder is sealed class
    //so if we like extend some funciontalities 
    //we can prepare decorator
    //decorator is extending functionality without inheritance 
    public class CodeBuilder
    {

        //now we have ready to use decorator and we can 
        //add more functionality or modify some
